...
<!-- <div class="header header-filter" style="background-image: url('https://images.unsplash.com/photo-1423655156442-ccc11daa4e99?crop=entropy&dpr=2&fit=crop&fm=jpg&h=750&ixjsv=2.1.0&ixlib=rb-0.3.5&q=50&w=1450');"> -->
    <div class="header header-filter" style="background-image: url('/img/examples/office.jpg');">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
        ...
        <div class="section text-center section-landing">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <h2 class="title">¿Por qué Mi App Shop?</h2>
                    <h5 class="description">Puedes revisar nuestra relación completa de productos, comparar precios y realizar tus pedidos.</h5>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="info">
                            ...
                            <p>Atendemos rápidamente cualquier consulta que tengas vía chat. No estás solo, estamos atentos a tus inquietudes.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="info">
