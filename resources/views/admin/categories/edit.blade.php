            ...
            <form method="post" action="{{ url('/admin/categories/'.$category->id.'/edit') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        @if ($category->image)
                        <p class="help-block">
                            Subir solo si desea reemplazar 
                            <a href="{{ asset('/images/categories/'.$category->image) }}" target="_blank">la imagen actual</a>
                        </p>
                        @endif
                    </div>
                </div>
               
                <textarea class="form-control" placeholder="Descripción detallada" rows="5" name="description">{{ old('description', $category->description) }}</textarea >
